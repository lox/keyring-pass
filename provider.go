...
const Backend = keyring.PassBackend
...
func Dir(dir string) Option {
	return func(cfg *Config) { cfg.PassDir = dir }
}

func Cmd(cmd string) Option {
	return func(cfg *Config) { cfg.PassCmd = cmd }
}

func Prefix(prefix string) Option {
	return func(cfg *Config) { cfg.PassPrefix = prefix }
}
...
func Provider(opts ...Option) keyring.Provider {
	...
	return keyring.Provider{
		Backend: Backend,
		Open: func(ctx context.Context, _ keyring.OpenOptions) (keyring.Keyring, error) {
